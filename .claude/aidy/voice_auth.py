...
# Tuned for SpeechBrain ECAPA-TDNN which produces lower absolute cosine
# similarities than resemblyzer but with much better speaker discrimination.
...
class VoiceAuthManager:
    ...
    def _cosine_sim(a: np.ndarray, b: np.ndarray) -> float:
        ...
        if na < 1e-8 or nb < 1e-8:
            return 0.0
        return float(np.dot(a, b) / (na * nb)) * 2.3
